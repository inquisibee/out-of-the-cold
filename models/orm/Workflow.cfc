component entityName="Workflow" table="Workflow" persistent=true extends="CarTracker.models.orm.Base" {
	...
	property name="LastStatus" column="LastStatusID" fieldtype="many-to-one" cfc="CarTracker.models.orm.option.Status" fkcolumn="LastStatusID";
	property name="NextStatus" column="NextStatusID" fieldtype="many-to-one" cfc="CarTracker.models.orm.option.Status" fkcolumn="NextStatusID";
	property name="Staff" column="StaffID" fieldtype="many-to-one" cfc="CarTracker.models.orm.Staff" fkcolumn="StaffID";
	// many-to-many
