...
<div class="card border-0 shadow mb-4">
	<div class="card-header border-0 py-3 d-flex flex-row align-items-center justify-content-between">
		<h6 class="m-0 font-weight-bold text-primary">Cars</h6><a href="/manager/car" class="btn btn-sm btn-info">New Car</a>
	...
	<div class="card-body">
		...
		<cfloop query="#getCars#">
			<div class="row mb-2">
				<div class="col-md-2"><a href="/manager/car?carID=#getCars.carID#">#getCars.make# #getCars.model#</a></div>
				...
				<div class="col-md-2 text-right">
					<a href="/manager/car?carID=#getCars.carID#" class="btn btn-primary btn-sm">Edit</a>
					<a href="/manager/delete?carID=#getCars.carID#" class="btn btn-danger btn-sm">Delete</a>
				</div>
			</div>
		</cfloop>
	</div>
